(function() {
	...
	function e(c, e) {
			...
			return {
				...
				contents : [ {
					...
					elements : [ {
						...
						align : "center",
						style : "width:150px",
						items : [ [ b.notset, "" ], [ b.circle, "circle" ],
								[ b.disc, "disc" ], [ b.square, "square" ] ],
						setup : function(a) {
						...
						commit : function(a) {
							var b = this.getValue();
							b ? a.setStyle("list-style-type", b) : a
		...
		if ("numberedListStyle" == e) {
			var g = [ [ b.notset, "" ], [ b.lowerRoman, "lower-roman" ],
						...
						children : [
								{
									...
									validate : CKEDITOR.dialog.validate
											.integer(b.validateStartNumber),
									setup : function(a) {
										a = a.getFirst(f).getAttribute("value")
												|| a.getAttribute("start") || 1;
										this.setValue(a)
									},
									commit : function(a) {
										var b = a.getFirst(f), c = b
												.getAttribute("value")
												|| a.getAttribute("start") || 1;
										a.getFirst(f).removeAttribute("value");
										var d = parseInt(this.getValue(), 10);
										isNaN(d) ? a.removeAttribute("start")
												: a.setAttribute("start", d);
										a = b;
										b = c;
										for (d = isNaN(d) ? 1 : d; (a = a
												.getNext(f))
												&& b++;)
								...
								},
								{
									...
									commit : function(a) {
										var b = this.getValue();
										b ? a.setStyle("list-style-type", b)
												: a
														.removeStyle("list-style-type")
									}
								} ]
